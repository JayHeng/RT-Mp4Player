...
void BOARD_InitLcdifPixelClock(void)
{
     ...
     * (800 + 48 + 88 + 112) * (600 + 3 + 39 + 21) * 60 = 39.8M.
     * Here set the LCDIF pixel clock to 40M.
     */
...
int main(void)
{
    ...
    lcdclk = CLOCK_GetFreq(kCLOCK_VideoPllClk);
    PRINTF("coreclk: %d; ahbclk: %d; lcdclk: %d\r\n", coreclk, ahbclk, lcdclk);
