...
AT_NONCACHEABLE_SECTION_ALIGN(
    static uint8_t s_lcdBuffer[DEMO_LCD_BUFFER_COUNT][DEMO_PANEL_HEIGHT][DEMO_PANEL_WIDTH * DEMO_LCD_BUFFER_BPP],
    FRAME_BUFFER_ALIGN);
...
static void DEMO_InitDisplay(void)
{
    ...
    fbInfo.strideBytes = DEMO_PANEL_WIDTH * DEMO_LCD_BUFFER_BPP;
...
static void DEMO_CSI_MIPI_RGB(void)
{
    ...
    pxp_output_buffer_config_t outputBufferConfig = {
        ...
        .buffer1Addr    = 0U,
        .pitchBytes     = DEMO_PANEL_WIDTH * DEMO_LCD_BUFFER_BPP,
#if DEMO_ROTATE_FRAME
        .width  = DEMO_PANEL_HEIGHT,
    ...
    PXP_SetProcessSurfaceScaler(DEMO_PXP, DEMO_CAMERA_WIDTH, DEMO_CAMERA_HEIGHT, DEMO_PANEL_HEIGHT, DEMO_PANEL_WIDTH);
#else
    PXP_SetProcessSurfaceScaler(DEMO_PXP, DEMO_CAMERA_WIDTH, DEMO_CAMERA_HEIGHT, DEMO_PANEL_WIDTH, DEMO_PANEL_HEIGHT);
#endif
